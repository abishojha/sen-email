...
#loading {
 ...
 <link rel="stylesheet" href="dataTables/1.10.16/css/dataTables.bootstrap.min.css"> 
 ...
 <nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header"> 
      <a  onClick="refreshModal()" class="navbar-brand">ACCESS MANAGEMENT</a>
    </div>
    <ul class="nav navbar-nav">
    
      <li id="addUser" class="active"><a href="#">ADD USER ACCESS</a></li>
      <li id="editUser" class="active"><a href="#">MANAGE USER/ACCESS</a></li> 
      <li id="viewBranch" class="active"><a href="#">VIEW BRANCH ACCESS</a></li>
      <li id="seacrhUser" class="active"><a href="#">TRACK USER</a></li>      
    </ul>
...
<table id="example" align="center" class="table table-striped table-bordered" cellspacing="0" style="width:90%;" >
        <thead>
            <tr>
               <th>Branch</th>
                                      <th>User Name</th>
...
<div class="modal fade"  id="makerChk" >
 <div class="modal-dialog">
  <div class="modal-content"
   style='padding-bottom: 0px; margin-bottom: 0px;'>
   <div class="modal-body" style='padding: 0px;'>
    <div class="panel panel-primary" style="margin-bottom: 0px;">
<!--      <button type="button" class="close" title="Close" onclick="refreshModal()">
 -->     
 
     <button type="button" class="close" data-dismiss="modal"
      aria-hidden="true" title="Close">
     ...
     <div class="panel-body">
	  ...
	  <br/>
        <label>USER NAME: </label>&nbsp;&nbsp;&nbsp;       
			<input class="form-control" type="text" id="userAccName">					
	 <br/>
        <label>CBS ID: </label>&nbsp;&nbsp;&nbsp;       
	  ...
	  <br/>      
       ...
       <label>REMARKS: </label>&nbsp;&nbsp;&nbsp;       
	  <input class="form-control" type="text" id="userRemarks" >		
	   <br/><br/>	   
   ...
   <div class="modal-body" style='padding: 0px;'>
    <div class="panel panel-primary" style="margin-bottom: 0px;">
     <button type="button" class="close"
       title="Close" class="close" data-dismiss="modal"
      aria-hidden="true" title="Close">
      <span style="font-size: 1.6em; padding-right: 10px;" >&times;</span>
     </button>
     <div class="panel-heading" style="">
     ...
     <div class="panel-body">
	  ...
	  <br/>
        <label>USER NAME: </label>&nbsp;&nbsp;&nbsp;       
			<input class="form-control" type="text" id="updAccName" >					
	 <br/>
        <label>CBS ID: </label>&nbsp;&nbsp;&nbsp;       
	  ...
	  <br/>      
       ...
       <label>REMARKS: </label>&nbsp;&nbsp;&nbsp;       
	  <input class="form-control" type="text" id="updRemarks" >		
	   <br/><br/>	   
