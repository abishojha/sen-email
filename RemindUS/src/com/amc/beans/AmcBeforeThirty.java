...
public class AmcBeforeThirty {
	...
	public String toString() {
		return "AmcBeforeThirty [vendorId=" + vendorId + ", vendorNm=" + vendorNm + ", amcPurpose=" + amcPurpose
				+ ", amcStartDate=" + amcStartDate + ", amcEndDate=" + amcEndDate + ", amcStatus=" + amcStatus
				+ ", daysLeft=" + daysLeft + ", emailStatus=" + emailStatus + "]";
	}
