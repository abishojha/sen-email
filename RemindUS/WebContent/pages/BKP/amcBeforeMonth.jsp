					                           	 ...
					                           	 <c:forEach var="test" items="${listAmcDetail}">
								                      <tr id="${test.vendorId}">							
							                         	...
							                         	<td align="center">${test.daysLeft}</td>
							                           	...
							                           	<td align="center">
							                           	<input type="button" onClick="showUpdate('${test.vendorId}');"  class="btn btn-danger" value="Edit"></td>
					                       			</tr>
					                       	</c:forEach>
							                    </tbody>
						 </table>
